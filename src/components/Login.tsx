  ...
  return (
    <div className="flex-grow flex items-center justify-center px-4 py-8 md:py-16">
      <div className="w-full max-w-md bg-white dark:bg-background-dark/80 border-2 border-brand/10 p-8 rounded-custom retro-card shadow-lg transition-colors">
        ...
        {/* OAuth Section */}
        <div className="mb-6">
          <button className="w-full flex items-center justify-center space-x-3 py-3 border-2 border-brand/20 rounded-custom hover:bg-brand/5 dark:hover:bg-brand/20 transition-colors font-bold uppercase tracking-widest text-xs text-vintage-navy dark:text-white">
